    ...
    <div className="min-h-screen bg-bone flex flex-row-reverse">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12">
        <div className="max-w-sm w-full mx-auto">
          ...
          <h1 className="text-2xl font-bold mb-2 text-forest">Get started free</h1>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-[10px] text-error">Passwords don&apos;t match</p>
            </div>
            ...
            <div className="flex items-start gap-3 mt-6">
              ...
              <label htmlFor="terms" className="text-xs text-slate-sub leading-relaxed">
                I agree to the <Link href="#" className="underline hover:text-forest">Terms of Service</Link> and <Link href="#" className="underline hover:text-forest">Privacy Policy</Link>.
              </label>
            </div>
          ...
          <p className="mt-12 text-center text-sm text-slate-sub">
            ...
            <Link href="/login" className="text-forest font-semibold hover:text-brass transition-colors">Log in</Link>
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md relative">
          ...
          <div className="bg-bone border border-line rounded-xl p-8 shadow-2xl relative z-10">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm text-slate">
                <div className="w-5 h-5 rounded-full bg-success/20 flex items-center justify-center text-success">✓</div>
                Client shared boards
              </li>
              <li className="flex items-center gap-3 text-sm text-slate">
                <div className="w-5 h-5 rounded-full bg-success/20 flex items-center justify-center text-success">✓</div>
                Last 3 versions tracked
              </li>
            </ul>
          </div>
        </div>
